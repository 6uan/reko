    ...
    <aside className="fixed left-0 top-0 bottom-0 w-70 bg-(--bg-2) border-r border-(--line) flex flex-col z-40 max-lg:hidden">
      ...
      <div className="mt-auto px-3 pb-4 flex flex-col gap-3">
        ...
        <a
          ...
          className="flex items-center justify-center no-underline text-(--ink-4) hover:text-(--ink-3) transition-colors"
        >
          <svg viewBox="0 0 365 37" fill="none" className="h-3.5 w-auto">
