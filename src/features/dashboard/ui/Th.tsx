 ...
 *
 *   <Th>Activity</Th>                       // px-4 text-left default
 *   <Th className="px-4 text-right">Runs</Th>  // override alignment
 */
...
export default function Th({ children, className = 'px-4 text-left' }: Props) {
  return (
    <th
